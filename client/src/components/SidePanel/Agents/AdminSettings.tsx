...
import { Permissions, SystemRoles, roleDefaults, PermissionTypes } from 'syntaxis-data-provider';
                  ...
                  {selectedRole === SystemRoles.ADMIN && agentPerm === Permissions.USE && (
                    <>
                      <div className="mb-2 max-w-full whitespace-normal break-words text-sm text-red-600">
                        ...
                        {'\n'}
                        <a
                          href="https://www.syntaxis.ai/docs/configuration/syntaxis_yaml/object_structure/interface"
                          target="_blank"
                          rel="noreferrer"
