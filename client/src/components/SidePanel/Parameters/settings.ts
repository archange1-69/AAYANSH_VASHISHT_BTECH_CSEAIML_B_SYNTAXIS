import {
  ...
  BedrockProviders,
  anthropicSettings,
} from 'syntaxis-data-provider';
import type { SettingsConfiguration, SettingDefinition } from 'syntaxis-data-provider';
...
const syntaxis: Record<string, SettingDefinition> = {
  modelLabel: {
    key: 'modelLabel',
...
const openAIParams: Record<string, SettingDefinition> = {
  ...
  promptPrefix: syntaxis.promptPrefix,
...
const googleConfig: SettingsConfiguration = [
  syntaxis.modelLabel,
  syntaxis.promptPrefix,
  syntaxis.maxContextTokens,
  google.maxOutputTokens,
  google.temperature,
  google.topP,
  google.topK,
  syntaxis.resendFiles,
];
