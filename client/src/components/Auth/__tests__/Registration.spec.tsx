...
import * as mockDataProvider from 'syntaxis-data-provider/react-query';
import type { TStartupConfig } from 'syntaxis-data-provider';
...
jest.mock('syntaxis-data-provider/react-query');
