const { Run, Providers } = require('@syntaxis/agents');
const { providerEndpointMap, KnownEndpoints } = require('syntaxis-data-provider');

/**
 * @typedef {import('@syntaxis/agents').t} t
 * @typedef {import('@syntaxis/agents').StandardGraphConfig} StandardGraphConfig
 ...
 * @typedef {import('@syntaxis/agents').LLMConfig} LLMConfig
