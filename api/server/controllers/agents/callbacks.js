...
const { Tools, StepTypes, FileContext } = require('syntaxis-data-provider');
const {
  EnvVar,
  Providers,
  GraphEvents,
...
} = require('@syntaxis/agents');
const { processCodeOutput } = require('~/server/services/Files/Code/process');
const { loadAuthValues } = require('~/server/services/Tools/credentials');
const { saveBase64Image } = require('~/server/services/Files/process');
const { logger, sendEvent } = require('~/config');

/** @typedef {import('@syntaxis/agents').Graph} Graph */
/** @typedef {import('@syntaxis/agents').EventHandler} EventHandler */
/** @typedef {import('@syntaxis/agents').ModelEndData} ModelEndData */
/** @typedef {import('@syntaxis/agents').ToolEndData} ToolEndData */
/** @typedef {import('@syntaxis/agents').ToolEndCallback} ToolEndCallback */
/** @typedef {import('@syntaxis/agents').ChatModelStreamHandler} ChatModelStreamHandler */
/** @typedef {import('@syntaxis/agents').ContentAggregatorResult['aggregateContent']} ContentAggregator */
/** @typedef {import('@syntaxis/agents').GraphEvents} GraphEvents */
