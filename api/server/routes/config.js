...
const { CacheKeys, defaultSocialLogins, Constants } = require('syntaxis-data-provider');
...
router.get('/', async function (req, res) {
  ...
  try {
    /** @type {TStartupConfig} */
    const payload = {
      appTitle: process.env.APP_TITLE || 'syntaxis',
      ...
      helpAndFaqURL: process.env.HELP_AND_FAQ_URL || 'https://syntaxis.ai',
