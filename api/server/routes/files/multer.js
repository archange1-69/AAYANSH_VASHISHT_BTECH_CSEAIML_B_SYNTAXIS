...
const { fileConfig: defaultFileConfig, mergeFileConfig } = require('syntaxis-data-provider');
...
/**
 *
 * @param {import('syntaxis-data-provider').FileConfig | undefined} customFileConfig
 */
