...
const { CacheKeys, configSchema, EImageOutputType } = require('syntaxis-data-provider');
...
const defaultConfigPath = path.resolve(projectRoot, 'syntaxis.yaml');
...
https://www.syntaxis.ai/docs/configuration/stt_tts`);
      }
