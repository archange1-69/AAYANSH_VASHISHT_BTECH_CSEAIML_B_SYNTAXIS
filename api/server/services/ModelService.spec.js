...
const { EModelEndpoint, defaultModels } = require('syntaxis-data-provider');
...
describe('getOpenAIModels with mocked config', () => {
  it('uses alternative behavior when userProvidedOpenAI is true', async () => {
    ...
    jest.mock('syntaxis-data-provider', () => {
      const original = jest.requireActual('syntaxis-data-provider');
      return {
        ...original,
        defaultModels: {
