const { EModelEndpoint } = require('syntaxis-data-provider');
const { normalizeEndpointName } = require('~/server/utils');
const { logger } = require('~/config');

/**
 * Sets up Model Specs from the config (`syntaxis.yaml`) file.
...
For more information, see the documentation at https://www.syntaxis.ai/docs/configuration/syntaxis_yaml/object_structure/model_specs#endpoint`);
      continue;
    }
