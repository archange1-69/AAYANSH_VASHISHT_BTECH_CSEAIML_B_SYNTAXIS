...
const deprecatedVariables = [
  {
    key: 'CHECK_BALANCE',
    description:
      'Please use the `balance` field in the `syntaxis.yaml` config file instead.\nMore info: https://syntaxis.ai/docs/configuration/syntaxis_yaml/object_structure/balance#overview',
  },
  {
    key: 'START_BALANCE',
    description:
...
function checkVariables() {
  ...
  if (hasDefaultSecrets) {
    ...
    https://www.syntaxis.ai/toolkit/creds_generator
...
Latest version: ${Constants.CONFIG_VERSION}
      ...
      https://www.syntaxis.ai/changelog\n\n`,
    );
  }
}
...
function checkPasswordReset() {
  ...
  if (!emailEnabled && passwordResetAllowed) {
    logger.warn(
      ...
      https://www.syntaxis.ai/docs/configuration/authentication/email
