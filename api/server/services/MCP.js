...
const { Constants: AgentConstants, Providers } = require('@syntaxis/agents');
const {
  Constants,
  ContentTypes,
 ...
 * @param {import('@syntaxis/agents').Providers | EModelEndpoint} params.provider - The provider for the tool.
