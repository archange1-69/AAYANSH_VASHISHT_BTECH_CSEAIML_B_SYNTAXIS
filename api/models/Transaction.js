...
const { transactionSchema } = require('@syntaxis/data-schemas');
 ...
 * @param {import('mongoose').UpdateQuery<import('@syntaxis/data-schemas').IBalance>['$set']} [params.setValues] - Optional additional fields to set.
