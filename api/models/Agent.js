...
const { agentSchema } = require('@syntaxis/data-schemas');
const { SystemRoles, Tools } = require('syntaxis-data-provider');
const { GLOBAL_PROJECT_NAME, EPHEMERAL_AGENT_ID, mcp_delimiter } =
  require('syntaxis-data-provider').Constants;
const { CONFIG_STORE, STARTUP_CONFIG } = require('syntaxis-data-provider').CacheKeys;
const {
  getProjectByName,
 ...
 * @param {import('@syntaxis/agents').ClientOptions} [params.model_parameters]
