...
(async () => {
  ...
  console.purple('Removing all tags for syntaxis `deployed` images...');
  const repositories = ['ghcr.io/danny-avila/syntaxis-dev-api', 'syntaxis-client'];
  ...
  console.purple('Pulling latest syntaxis images...');
