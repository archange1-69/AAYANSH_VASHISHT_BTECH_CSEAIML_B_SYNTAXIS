...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should throw an error if environment variables are set but not configured', () => {
    const validConfigs: TAzureGroups = [
      {
        group: 'syntaxis-westus',
        apiKey: '${WESTUS_API_KEY}',
        instanceName: 'syntaxis-westus',
      ...
      {
        group: 'syntaxis-eastus',
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'syntaxis-eastus',
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'syntaxis-westus'
    expect(groupMap).toHaveProperty('syntaxis-westus');
    expect(groupMap['syntaxis-westus']).toEqual(
    ...
    // Check groupMap for 'syntaxis-eastus'
    expect(groupMap).toHaveProperty('syntaxis-eastus');
    expect(groupMap['syntaxis-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'syntaxis-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'syntaxis-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'syntaxis-eastus',
